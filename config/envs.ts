...
interface EnvVars {
  ...
  POSTULANTES_MICROSERVICE_NAME: string;
  POSTULANTES_MICROSERVICE_HOST: string;
  POSTULANTES_MICROSERVICE_PORT: number;
...
const envsSchema = joi
  .object({
    ...
    POSTULANTES_MICROSERVICE_NAME: joi.string().required(),
    POSTULANTES_MICROSERVICE_HOST: joi.string().default('localhost'),
    POSTULANTES_MICROSERVICE_PORT: joi.number().required(),
...
export const envs = {
  ...
  POSTULANTES_MICROSERVICE_NAME: envVars.POSTULANTES_MICROSERVICE_NAME,
  POSTULANTES_MICROSERVICE_HOST: envVars.POSTULANTES_MICROSERVICE_HOST,
  POSTULANTES_MICROSERVICE_PORT: envVars.POSTULANTES_MICROSERVICE_PORT,
